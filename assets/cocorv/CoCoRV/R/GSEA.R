...
GSEA = function(data, pathway, alternative = "two.sided", p = 1, 
  ...
  pathwayResult = data.table(pathwayID, pathwayResult[, 1], 
    pathwayResult[, 2], FDR, pathwayResult[, 3], pathwayResult[, 4], size, leadingEdge)
  
  colnames(pathwayResult)[c(2, 3, 5, 6)] = c("ES", "pathwayPvalue", "nExtreme", "nTotal")

  pathwayResult = pathwayResult[order(pathwayResult$pathwayPvalue), , drop = F]
